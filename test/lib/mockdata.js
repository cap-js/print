const elements_invoice = {
  ...
  attachment: {
    ...
    "@print.fileContent.usedInAction": ["releaseInvoice"],
  ...
  qName: {
    "@print.queue.usedInAction": ["releaseInvoice"],
  ...
  numberOfCopies: {
    "@print.numberOfCopies.usedInAction": ["releaseInvoice"],
    type: "cds.Integer",
    name: "numberOfCopies",
  },
  IsActiveEntity: {
